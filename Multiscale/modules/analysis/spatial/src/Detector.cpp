...
void Detector::addAverageMeasuresToPropertyTree(pt::ptree &propertyTree) {
    propertyTree.put<double>(LABEL_EXPERIMENT_TIMEPOINT_AVG_CLUSTEREDNESS, avgClusterednessDegree);
    propertyTree.put<double>(LABEL_EXPERIMENT_TIMEPOINT_AVG_DENSITY, avgDensity);
}
...
const string Detector::LABEL_EXPERIMENT_TIMEPOINT_AVG_CLUSTEREDNESS = "experiment.timepoint.avgClusteredness";
const string Detector::LABEL_EXPERIMENT_TIMEPOINT_AVG_DENSITY       = "experiment.timepoint.avgDensity";
