...
namespace multiscale {
    ...
    namespace verification {
        ...
        class LogicPropertyGrammar : public qi::grammar<
            Iterator, ProbabilisticLogicPropertyAttribute(), ascii::space_type> {
            ...
            private:
                ...
                qi::rule<Iterator, ProbabilisticLogicPropertyAttribute(), ascii::space_type>
                ...
                qi::rule<Iterator, FutureLogicPropertyAttribute(), ascii::space_type>
                    futureLogicPropertyRule;                    /*!< The rule for parsing a "future" logic property */
                qi::rule<Iterator, GlobalLogicPropertyAttribute(), ascii::space_type>
                    globalLogicPropertyRule;                    /*!< The rule for parsing a "global" logic property */
                qi::rule<Iterator, NextLogicPropertyAttribute(), ascii::space_type>
                    nextLogicPropertyRule;                      /*!< The rule for parsing a "next" logic property */
                qi::rule<Iterator, NextKLogicPropertyAttribute(), ascii::space_type>
                    nextKLogicPropertyRule;                     /*!< The rule for parsing a "next K" logic property */

                qi::rule<Iterator, AndLogicPropertyAttribute(), ascii::space_type>
                    andLogicPropertyRule;                       /*!< The rule for parsing an "and" logic property */
                qi::rule<Iterator, OrLogicPropertyAttribute(), ascii::space_type>
                    orLogicPropertyRule;                        /*!< The rule for parsing an "or" logic property */
                qi::rule<Iterator, ImplicationLogicPropertyAttribute(), ascii::space_type>
                    implicationLogicPropertyRule;               /*!< The rule for parsing an "implication" logic
                                                                     property */
                qi::rule<Iterator, EquivalenceLogicPropertyAttribute(), ascii::space_type>
                    equivalenceLogicPropertyRule;               /*!< The rule for parsing an "equivalence" logic
                                                                     property */
                qi::rule<Iterator, UntilLogicPropertyAttribute(), ascii::space_type>
                ...
                qi::rule<Iterator, NumericSpatialMeasureAttribute(), ascii::space_type>
                    numericSpatialRule;                         /*!< The rule for parsing a numeric spatial measure */
                ...
                qi::rule<Iterator, std::string(), ascii::space_type>
                    stateVariableNameRule;                      /*!< The rule for parsing the name of a state
                                                                     variable without escaping white space */
