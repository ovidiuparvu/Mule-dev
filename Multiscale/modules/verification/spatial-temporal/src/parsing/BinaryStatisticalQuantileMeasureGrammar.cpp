...
#include "multiscale/verification/spatial-temporal/parsing/BinaryStatisticalQuantileMeasureGrammarDefinition.hpp"
...
template class BinaryStatisticalQuantileMeasureGrammar<iteratorType>;
