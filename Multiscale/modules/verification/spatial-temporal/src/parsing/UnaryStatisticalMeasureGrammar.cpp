...
#include "multiscale/verification/spatial-temporal/parsing/UnaryStatisticalMeasureGrammarDefinition.hpp"
...
template class UnaryStatisticalMeasureGrammar<iteratorType>;
