...
const std::string TypeSemanticsTable::TYPE_SEMANTICS_TABLE_XSD_PATH             = "/usr/local/share/mule/config/verification/spatial-temporal/schema/multiscale_architecture_graph.xsd";
