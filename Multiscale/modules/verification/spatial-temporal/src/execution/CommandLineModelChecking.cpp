...
void CommandLineModelChecking::printHelpClosingMessage() {
    std::cout   << std::endl
                << HELP_VERSION_LABEL           << std::endl
                << HELP_VERSION_MSG             << std::endl
                << std::endl
...
const std::string   CommandLineModelChecking::HELP_NAME_MSG                                                     = "    Mule - Multiscale multidimensional spatio-temporal model checker";
...
const std::string   CommandLineModelChecking::HELP_DESCRIPTION_MSG                                              = "    Mule is a multiscale multidimensional spatio-temporal approximate probabilistic model checker. It can be used for two different types of applications. First of all Mule can be employed to validate logic properties against multidimensional multiscale models. Secondly it can be used in reverse mode as a method to query time series data generated by in vivo/vitro experiments. Properties of interest are formalised using a multiscale spatio-temporal logic and their validity is checked using Mule.";
const std::string   CommandLineModelChecking::HELP_VERSION_LABEL                                                = "VERSION:";
const std::string   CommandLineModelChecking::HELP_VERSION_MSG                                                  = "    Mule 1.1.5.";
const std::string   CommandLineModelChecking::HELP_AUTHOR_LABEL                                                 = "AUTHOR:";
const std::string   CommandLineModelChecking::HELP_AUTHOR_MSG                                                   = "    The author of this software is Ovidiu Pârvu.";
const std::string   CommandLineModelChecking::HELP_COPYRIGHT_LABEL                                              = "COPYRIGHT:";
const std::string   CommandLineModelChecking::HELP_COPYRIGHT_MSG                                                = "    Copyright Ovidiu Pârvu 2015.";
