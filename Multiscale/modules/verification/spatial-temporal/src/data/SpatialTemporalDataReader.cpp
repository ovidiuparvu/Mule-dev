...
void
SpatialTemporalDataReader::setSpatialEntityScaleAndSubsystem(const pt::ptree &spatialEntityTree,
                                                             const std::shared_ptr<SpatialEntity> &spatialEntity) {
    boost::optional<std::string> scaleAndSubsystem = spatialEntityTree.get_optional<std::string>(
                                                         LABEL_SPATIAL_ENTITY_SCALE_AND_SUBSYSTEM
                                                     );

    spatialEntity->setScaleAndSubsystem(
        scaleAndSubsystem.get_value_or(ScaleAndSubsystem::DEFAULT_VALUE)
    );
}
...
const std::string SpatialTemporalDataReader::LABEL_NUMERIC_STATE_VARIABLE_SCALE_AND_SUBSYSTEM   = "<xmlattr>.scaleAndSubsystem";
