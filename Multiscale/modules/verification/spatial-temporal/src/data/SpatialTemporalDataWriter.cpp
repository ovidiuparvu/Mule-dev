...
void SpatialTemporalDataWriter::addAutoGeneratedCommentToPropertyTree(pt::ptree &propertyTree) {
    propertyTree.add<std::string>(LABEL_COMMENT, CONTENTS_COMMENT_AUTO_GENERATED);
}
...
void SpatialTemporalDataWriter::addAttributeToTree(const std::string &attributeName,
    ...
    // Add the semantic type value to the semantic type tree
    attributeTree.add(attributeName, attributeValue);

    // Add the semantic type tree to the property tree
...
const std::string SpatialTemporalDataWriter::CONTENTS_COMMENT_AUTO_GENERATED    = "";
