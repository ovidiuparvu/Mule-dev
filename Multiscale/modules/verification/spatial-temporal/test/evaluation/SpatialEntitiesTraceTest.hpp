...
TEST_F(SpatialEntitiesTraceTest, BinaryNumericFilter) {
    EXPECT_FALSE(RunEvaluationTest("P >= 0.3 [G [0, 11] count(area(filter(clusters, area < subtract(area, 0.0001)))) > 0]"));
}
...
TEST_F(SpatialEntitiesTraceTest, BinaryNumericMeasureAdd) {
    EXPECT_TRUE(RunEvaluationTest("P >= 0.3 [count(area(clusters)) <= add(" + StringManipulator::toString<double>(aMinValue) + ", 0.0111)]"));
}

TEST_F(SpatialEntitiesTraceTest, BinaryNumericMeasureDiv) {
    EXPECT_FALSE(RunEvaluationTest("P >= 0.3 [count(area(clusters)) < div(2, 3)]"));
}

TEST_F(SpatialEntitiesTraceTest, BinaryNumericMeasureLog) {
    EXPECT_TRUE(RunEvaluationTest("P >= 0.3 [count(area(clusters)) >= log(4.33333, 9.12312312)]"));
}

TEST_F(SpatialEntitiesTraceTest, BinaryNumericMeasureMod) {
    EXPECT_TRUE(RunEvaluationTest("P >= 0.3 [count(area(clusters)) <= mod(1.00001, 8)]"));
}

TEST_F(SpatialEntitiesTraceTest, BinaryNumericMeasureMultiply) {
    EXPECT_TRUE(RunEvaluationTest("P >= 0.3 [count(area(clusters)) <= multiply(2, 0.50001)]"));
}
...
TEST_F(SpatialEntitiesTraceTest, BinaryNumericMeasureSubtract) {
    EXPECT_TRUE(RunEvaluationTest("P >= 0.3 [count(area(filter(clusters, area > 1))) = 0]"));
}
...
TEST_F(SpatialEntitiesTraceTest, BinaryNumericNumeric) {
    EXPECT_TRUE(RunEvaluationTest("P >= 0.3 [median([0, 10] add(count(area(clusters)), 2)) < 7.0001]"));
}
...
TEST_F(SpatialEntitiesTraceTest, BinaryNumericSpatial) {
    EXPECT_TRUE(RunEvaluationTest("P >= 0.3 [F [0, 11] (sum(div(area(clusters), area(clusters))) = 11)]"));
}
...
TEST_F(SpatialEntitiesTraceTest, BinaryNumericTemporal) {
    EXPECT_TRUE(RunEvaluationTest("P >= 0.3 [div(count(area(clusters)), 2) > 0.49]"));
}
...
TEST_F(SpatialEntitiesTraceTest, BinaryStatisticalMeasure) {
    EXPECT_FALSE(RunEvaluationTest("P >= 0.3 [covar(area(clusters), area(clusters)) >= 0.001]"));
}
...
TEST_F(SpatialEntitiesTraceTest, BinaryStatisticalNumeric) {
    EXPECT_FALSE(RunEvaluationTest("P >= 0.3 [covar(area(clusters), area(clusters)) >= 0.00034]"));
}
...
TEST_F(SpatialEntitiesTraceTest, BinaryStatisticalQuantileMeasurePercentile) {
    EXPECT_TRUE(RunEvaluationTest("P >= 0.3 [X[4] percentile(area(clusters), 4.3) = 1]"));
}

TEST_F(SpatialEntitiesTraceTest, BinaryStatisticalQuantileMeasureQuartile) {
    EXPECT_THROW(RunEvaluationTest("P >= 0.3 [X[4] quartile(area(clusters), 4.3) <= 0.5]"), NumericException);
}
...
TEST_F(SpatialEntitiesTraceTest, BinaryStatisticalQuantileNumeric) {
    EXPECT_TRUE(RunEvaluationTest("P >= 0.3 [percentile(area(clusters), 4.3) > 0.9999]"));
}
...
TEST_F(SpatialEntitiesTraceTest, BinaryStatisticalQuantileSpatial) {
    EXPECT_TRUE(RunEvaluationTest("P >= 0.3 [min([0, 10] percentile(area(clusters), 4.3)) = 1]"));
}
...
TEST_F(SpatialEntitiesTraceTest, BinaryStatisticalSpatial) {
    EXPECT_FALSE(RunEvaluationTest("P >= 0.3 [min([0, 4] covar(area(clusters), area(clusters))) > 0.000001]"));
}
...
TEST_F(SpatialEntitiesTraceTest, ChangeMeasureDifference) {
    EXPECT_TRUE(RunEvaluationTest("P >= 0.3 [d(max(area(clusters))) <= 2.41]"));
}

TEST_F(SpatialEntitiesTraceTest, ChangeMeasureRatio) {
    EXPECT_FALSE(RunEvaluationTest("P >= 0.3 [r(max(area(clusters))) < 3.4]"));
}
...
TEST_F(SpatialEntitiesTraceTest, ChangeTemporalNumericCollection) {
    EXPECT_TRUE(RunEvaluationTest("P >= 0.3 [max(r([0, 11] min(area(clusters)))) = 25]"));
}
...
TEST_F(SpatialEntitiesTraceTest, ChangeTemporalNumericMeasure) {
    EXPECT_TRUE(RunEvaluationTest("P >= 0.3 [r(max(area(clusters))) < 3.41]"));
}
...
TEST_F(SpatialEntitiesTraceTest, ComparatorGreaterThan) {
    EXPECT_FALSE(RunEvaluationTest("P <= 0.9 [count(area(clusters)) > 1]"));
}
...
TEST_F(SpatialEntitiesTraceTest, ComparatorGreaterThanOrEqual) {
    EXPECT_TRUE(RunEvaluationTest("P <= 0.9 [count(area(clusters)) >= 1]"));
}
...
TEST_F(SpatialEntitiesTraceTest, CompoundConstraint) {
    EXPECT_TRUE(RunEvaluationTest("P <= 0.9 [count(area(filter(clusters, (area <= 1.0001) ^ (area = 0.1)))) <= 1]"));
    EXPECT_FALSE(RunEvaluationTest("P <= 0.9 [count(area(filter(clusters, (area <= 1.0001) V (area = 0.3)))) = 0]"));
    EXPECT_FALSE(RunEvaluationTest("P <= 0.9 [count(area(filter(clusters, (area <= 1.0001) => (area = 0.1)))) > 1]"));
    EXPECT_TRUE(RunEvaluationTest("P <= 0.9 [count(area(filter(clusters, (area <= 1.0001) <=> (area = 0.1)))) < 1]"));
}

TEST_F(SpatialEntitiesTraceTest, CompoundConstraintMultiple) {
    EXPECT_TRUE(RunEvaluationTest("P <= 0.9 [count(area(filter(clusters, (area <= 1.0001) ^ (area = 0.1) ^ (~ area > 1)))) < 1]"));
    EXPECT_TRUE(RunEvaluationTest("P <= 0.9 [count(area(filter(clusters, (area <= 1.0001) V (area = 0.1) V (~ area > 1)))) <= 1]"));
    EXPECT_TRUE(RunEvaluationTest("P <= 0.9 [count(area(filter(clusters, (area <= 1.0001) => (area = 0.1) => (~ area > 1)))) = 1]"));
    EXPECT_TRUE(RunEvaluationTest("P <= 0.9 [count(area(filter(clusters, (area <= 1.0001) <=> (area = 0.1) <=> (~ area > 1)))) = 0]"));
}
...
TEST_F(SpatialEntitiesTraceTest, CompoundLogicProperty) {
    EXPECT_TRUE(RunEvaluationTest("P >= 0.3 [(avg(area(clusters)) >= 1) ^ (count(area(clusters)) >= 1)]"));
    EXPECT_TRUE(RunEvaluationTest("P >= 0.3 [(avg(area(clusters)) >= 1) V (count(area(clusters)) < 1)]"));
    EXPECT_FALSE(RunEvaluationTest("P >= 0.3 [(avg(area(clusters)) >= 1) => (count(area(clusters)) > 1)]"));
    EXPECT_TRUE(RunEvaluationTest("P >= 0.3 [(avg(area(clusters)) >= 1) <=> (count(area(clusters)) <= 1)]"));
}

TEST_F(SpatialEntitiesTraceTest, CompoundLogicPropertyMultiple) {
    EXPECT_FALSE(RunEvaluationTest("P >= 0.3 [(avg(area(clusters)) >= 1) ^ (count(area(clusters)) < 1) ^ 3 = 3]"));
    EXPECT_TRUE(RunEvaluationTest("P >= 0.3 [(avg(area(clusters)) >= 1) V (count(area(clusters)) < 1) V 3 = 3]"));
    EXPECT_TRUE(RunEvaluationTest("P >= 0.3 [(avg(area(clusters)) >= 1) => (count(area(clusters)) < 1) => 3 = 3]"));
    EXPECT_FALSE(RunEvaluationTest("P >= 0.3 [(avg(area(clusters)) >= 1) <=> (count(area(clusters)) < 1) <=> 3 = 3]"));
}
...
TEST_F(SpatialEntitiesTraceTest, ConstraintEnclosedByParentheses) {
    EXPECT_TRUE(RunEvaluationTest("P <= 0.9 [count(area(filter(clusters, (area < 1.00001)))) = 1]"));
}
...
TEST_F(SpatialEntitiesTraceTest, Constraint) {
    EXPECT_TRUE(RunEvaluationTest("P <= 0.9 [count(area(filter(clusters, area > 10000 V area < 1.001))) = 1]"));
}
...
TEST_F(SpatialEntitiesTraceTest, FilterNumericMeasure) {
    EXPECT_FALSE(RunEvaluationTest("P >= 0.3 [G [0, 11] count(area(filter(clusters, area > 0.5 ^ area < 1.0001))) > 0]"));
}
...
TEST_F(SpatialEntitiesTraceTest, FutureLogicProperty) {
    EXPECT_FALSE(RunEvaluationTest("P >= 0.3 [F [2, 3] (count(area(clusters)) >= 4)]"));
}
...
TEST_F(SpatialEntitiesTraceTest, GlobalLogicProperty) {
    EXPECT_TRUE(RunEvaluationTest("P >= 0.3 [G [2, 3] (count(area(clusters)) < 4)]"));
}
...
TEST_F(SpatialEntitiesTraceTest, HeterogeneousTimeseriesComponentPeak) {
    EXPECT_TRUE(RunEvaluationTest("P >= 0.3 [max(enteringValue(peak, [0, 11] avg(area(clusters)))) > 16.59]"));
}

TEST_F(SpatialEntitiesTraceTest, HeterogeneousTimeseriesComponentValley) {
    EXPECT_FALSE(RunEvaluationTest("P >= 0.3 [median(enteringValue(valley, [0, 11] count(area(clusters)))) < 2]"));
}
...
TEST_F(SpatialEntitiesTraceTest, HomogeneousHomogeneousTimeseries) {
    EXPECT_TRUE(RunEvaluationTest("P >= 0.3 [max(values(plateau, [0, 11] count(area(clusters)))) = 0]"));
}
...
TEST_F(SpatialEntitiesTraceTest, HomogeneousTimeseriesComponentAscent) {
    EXPECT_FALSE(RunEvaluationTest("P >= 0.3 [min(values(ascent, [0, 11] count(area(clusters)))) > 1]"));
}

TEST_F(SpatialEntitiesTraceTest, HomogeneousTimeseriesComponentDescent) {
    EXPECT_TRUE(RunEvaluationTest("P >= 0.3 [avg(timeSpan(descent, [0, 11] count(area(clusters)))) = 1]"));
}

TEST_F(SpatialEntitiesTraceTest, HomogeneousTimeseriesComponentPlateau) {
    EXPECT_FALSE(RunEvaluationTest("P >= 0.3 [mode(values(plateau, [0, 11] count(area(clusters)))) > 0]"));
}
...
TEST_F(SpatialEntitiesTraceTest, HomogeneousTimeseriesComponentUniformDescent) {
    EXPECT_FALSE(RunEvaluationTest("P >= 0.3 [avg(values(uniformDescent, [0, 11] avg(area(clusters)))) > 0]"));
}
...
TEST_F(SpatialEntitiesTraceTest, HomogeneousTimeseriesMeasureTimeSpan) {
    EXPECT_FALSE(RunEvaluationTest("P >= 0.3 [max(timeSpan(ascent, [0, 11] count(area(clusters)))) > 4]"));
}

TEST_F(SpatialEntitiesTraceTest, HomogeneousTimeseriesMeasureValue) {
    EXPECT_TRUE(RunEvaluationTest("P >= 0.3 [min(values(descent, [0, 11] count(area(clusters)))) = 2]"));
}
...
TEST_F(SpatialEntitiesTraceTest, LogicPropertyEnclosedByParentheses) {
    EXPECT_TRUE(RunEvaluationTest("P >= 0.3 [(count(area(clusters)) >= 0.99)]"));
}
...
TEST_F(SpatialEntitiesTraceTest, LogicProperty) {
    EXPECT_TRUE(RunEvaluationTest("P >= 0.3 [count(area(clusters)) >= 0.99999]"));
}
...
TEST_F(SpatialEntitiesTraceTest, MultipleLogicProperties1) {
    EXPECT_FALSE(RunEvaluationTest("P > 0.1234 [( d(4) >=  count(area(clusters)) ) ^ ( covar(area(clusters), area(clusters)) >= {A} ) V ( {B} = sqrt(add({B}, {C})) )]"));
}
...
TEST_F(SpatialEntitiesTraceTest, NextKLogicProperty) {
    EXPECT_TRUE(RunEvaluationTest("P >= 0.3 [X [3] (max(area(clusters)) >= 8.1999)]"));
}
...
TEST_F(SpatialEntitiesTraceTest, NextLogicProperty) {
    EXPECT_TRUE(RunEvaluationTest("P >= 0.3 [X (max(area(clusters)) <= 3.5)]"));
}
...
TEST_F(SpatialEntitiesTraceTest, NotConstraint) {
    EXPECT_FALSE(RunEvaluationTest("P <= 0.9 [count(area(filter(clusters, ~ (area <= 1)))) = 1]"));
}
...
TEST_F(SpatialEntitiesTraceTest, NotLogicProperty) {
    EXPECT_FALSE(RunEvaluationTest("P >= 0.3 [~(count(area(clusters)) >= 1)]"));
}
...
TEST_F(SpatialEntitiesTraceTest, NumericMeasure) {
    EXPECT_TRUE(RunEvaluationTest("P >= 0.3 [avg([0, 3] count(area(clusters))) = 2]"));
}
...
TEST_F(SpatialEntitiesTraceTest, NumericMeasureCollection) {
    EXPECT_TRUE(RunEvaluationTest("P >= 0.3 [min(area(clusters)) = 1]"));
}
...
TEST_F(SpatialEntitiesTraceTest, NumericStatisticalMeasure) {
    EXPECT_FALSE(RunEvaluationTest("P >= 0.3 [X min([0, 5] count(area(clusters))) <= 1]"));
}
...
TEST_F(SpatialEntitiesTraceTest, PrimarySpatialMeasureCollection) {
    EXPECT_FALSE(RunEvaluationTest("P >= 0.3 [F [0, 11] avg(area(clusters)) > 26.21]"));
}
...
TEST_F(SpatialEntitiesTraceTest, ProbabilisticLogicProperty) {
    EXPECT_TRUE(RunEvaluationTest("P >= 0.4 [count(area(clusters)) >= 1]"));
}
...
TEST_F(SpatialEntitiesTraceTest, ScaleAndSubsystem) {
    EXPECT_TRUE(RunEvaluationTest("P >= 0.4 [count(area(filter(clusters, scaleAndSubsystem = Organ.Kidney))) = 0]"));
}
...
TEST_F(SpatialEntitiesTraceTest, SimilarityMeasureAntiSimilar) {
    EXPECT_TRUE(RunEvaluationTest("P >= 0.3 [opposite([0, 11] count(area(clusters)), [0, 11] subtract(0, count(area(clusters))), 0)]"));
}

TEST_F(SpatialEntitiesTraceTest, SimilarityMeasureSimilar) {
    EXPECT_FALSE(RunEvaluationTest("P >= 0.3 [similar(r([0, 11] count(area(clusters))), r([0, 11] multiply(avg(area(clusters)), 2)), 0)]"));
}
...
TEST_F(SpatialEntitiesTraceTest, SimilarityTemporalNumericCollection) {
    EXPECT_TRUE(RunEvaluationTest("P >= 0.3 [similar([0, 11] count(area(clusters)), [0, 11] 6, 6)]"));
}
...
TEST_F(SpatialEntitiesTraceTest, SpatialMeasureArea) {
    EXPECT_TRUE(RunEvaluationTest("P <= 0.9 [count(area(filter(clusters, area > 0))) >= 1]"));
}

TEST_F(SpatialEntitiesTraceTest, SpatialMeasurePerimeter) {
    EXPECT_TRUE(RunEvaluationTest("P <= 0.9 [count(area(filter(clusters, perimeter > 0))) = 1]"));
}

TEST_F(SpatialEntitiesTraceTest, SpatialMeasureClusteredness) {
    EXPECT_TRUE(RunEvaluationTest("P <= 0.9 [count(area(filter(clusters, clusteredness > 0))) = 1]"));
}

TEST_F(SpatialEntitiesTraceTest, SpatialMeasureDensity) {
    EXPECT_TRUE(RunEvaluationTest("P <= 0.9 [count(area(filter(clusters, density > 0))) = 1]"));
}

TEST_F(SpatialEntitiesTraceTest, SpatialMeasureDistanceFromOrigin) {
    EXPECT_TRUE(RunEvaluationTest("P <= 0.9 [count(area(filter(clusters, distanceFromOrigin > 0))) = 1]"));
}

TEST_F(SpatialEntitiesTraceTest, SpatialMeasureAngle) {
    EXPECT_TRUE(RunEvaluationTest("P <= 0.9 [count(area(filter(clusters, angle > 0))) = 1]"));
}

TEST_F(SpatialEntitiesTraceTest, SpatialMeasureTriangleMeasure) {
    EXPECT_TRUE(RunEvaluationTest("P <= 0.9 [count(area(filter(clusters, triangleMeasure > 0))) = 1]"));
}

TEST_F(SpatialEntitiesTraceTest, SpatialMeasureRectangleMeasure) {
    EXPECT_TRUE(RunEvaluationTest("P <= 0.9 [count(area(filter(clusters, rectangleMeasure > 0))) = 1]"));
}

TEST_F(SpatialEntitiesTraceTest, SpatialMeasureCircleMeasure) {
    EXPECT_TRUE(RunEvaluationTest("P <= 0.9 [count(area(filter(clusters, circleMeasure > 0))) = 1]"));
}

TEST_F(SpatialEntitiesTraceTest, SpatialMeasureCentroidX) {
    EXPECT_TRUE(RunEvaluationTest("P <= 0.9 [count(area(filter(clusters, centroidX > 0))) = 1]"));
}

TEST_F(SpatialEntitiesTraceTest, SpatialMeasureCentroidY) {
    EXPECT_TRUE(RunEvaluationTest("P <= 0.9 [count(area(filter(clusters, centroidY > 0))) = 1]"));
}
...
TEST_F(SpatialEntitiesTraceTest, SpatialMeasureCollection) {
    EXPECT_TRUE(RunEvaluationTest("P >= 0.3 [F [0, 11] avg(area(clusters)) < 26.21]"));
}
...
TEST_F(SpatialEntitiesTraceTest, SubsetOperationDifference) {
    EXPECT_TRUE(RunEvaluationTest("P >= 0.3 [G [0, 11] count(area(difference(clusters, filter(clusters, area < 1)))) >= 1]"));
}

TEST_F(SpatialEntitiesTraceTest, SubsetOperationDifferenceRegion) {
    EXPECT_FALSE(RunEvaluationTest("P >= 0.3 [F [0, 11] count(area(difference(regions, clusters))) > 24]"));
}

TEST_F(SpatialEntitiesTraceTest, SubsetOperationIntersection) {
    EXPECT_FALSE(RunEvaluationTest("P >= 0.3 [F [0, 11] count(area(intersection(clusters, filter(clusters, area <= 1)))) >= 2]"));
}

TEST_F(SpatialEntitiesTraceTest, SubsetOperationIntersectionRegion) {
    EXPECT_FALSE(RunEvaluationTest("P >= 0.3 [F [0, 11] count(area(intersection(clusters, filter(regions, area > 0.5)))) > 0]"));
}

TEST_F(SpatialEntitiesTraceTest, SubsetOperationUnion) {
    EXPECT_TRUE(RunEvaluationTest("P >= 0.3 [G [0, 11] count(area(union(filter(clusters, area < 20), filter(clusters, area >= 20)))) > 0]"));
}

TEST_F(SpatialEntitiesTraceTest, SubsetOperationUnionRegion) {
    EXPECT_TRUE(RunEvaluationTest("P >= 0.3 [G [0, 11] count(area(union(clusters, regions))) >= 3]"));
}
...
TEST_F(SpatialEntitiesTraceTest, SubsetSpecificClusters) {
    EXPECT_TRUE(RunEvaluationTest("P >= 0.3 [count(area(clusters)) > 0]"));
}

TEST_F(SpatialEntitiesTraceTest, SubsetSpecificRegions) {
    EXPECT_FALSE(RunEvaluationTest("P >= 0.3 [count(area(regions)) < 2]"));
}
...
TEST_F(SpatialEntitiesTraceTest, SubsetSubsetOperation) {
    EXPECT_TRUE(RunEvaluationTest("P >= 0.3 [F [0, 11] count(area(union(clusters, clusters))) >= 4.3]"));
}
...
TEST_F(SpatialEntitiesTraceTest, TemporalNumericCollection) {
    EXPECT_TRUE(RunEvaluationTest("P >= 0.3 [min([0, 11] max(area(clusters))) = 1]"));
}
...
TEST_F(SpatialEntitiesTraceTest, TemporalNumericComparison) {
    EXPECT_FALSE(RunEvaluationTest("P >= 0.3 [max(area(clusters)) >= 1.0001]"));
}
...
TEST_F(SpatialEntitiesTraceTest, TemporalNumericMeasureCollection) {
    EXPECT_TRUE(RunEvaluationTest("P >= 0.3 [min([0, 11] count(area(clusters))) = 1]"));
}
...
TEST_F(SpatialEntitiesTraceTest, TimeseriesMeasureEnteringTime) {
    EXPECT_FALSE(RunEvaluationTest("P >= 0.3 [min(enteringTime(descent, [0, 11] count(area(clusters)))) < 2]"));
}

TEST_F(SpatialEntitiesTraceTest, TimeseriesMeasureEnteringValue) {
    EXPECT_FALSE(RunEvaluationTest("P >= 0.3 [min(enteringValue(uniformDescent, [0, 11] max(area(clusters)))) > 0]"));
}
...
TEST_F(SpatialEntitiesTraceTest, TimeseriesTimeseriesComponent) {
    EXPECT_TRUE(RunEvaluationTest("P >= 0.3 [median(enteringTime(peak, [0, 11] count(area(clusters)))) = 6]"));
}
...
TEST_F(SpatialEntitiesTraceTest, UnaryNumericFilter) {
    EXPECT_FALSE(RunEvaluationTest("P >= 0.3 [G [0, 11] count(area(filter(clusters, area <= round(area)))) > 1]"));
}
...
TEST_F(SpatialEntitiesTraceTest, UnaryNumericMeasureCeil) {
    EXPECT_TRUE(RunEvaluationTest("P >= 0.3 [count(area(clusters)) = ceil(0.3)]"));
}

TEST_F(SpatialEntitiesTraceTest, UnaryNumericMeasureFloor) {
    EXPECT_FALSE(RunEvaluationTest("P >= 0.3 [count(area(clusters)) = floor(0.49)]"));
}

TEST_F(SpatialEntitiesTraceTest, UnaryNumericMeasureRound) {
    EXPECT_TRUE(RunEvaluationTest("P >= 0.3 [count(area(clusters)) = round(0.50001)]"));
}
...
TEST_F(SpatialEntitiesTraceTest, UnaryNumericMeasureSqrt) {
    EXPECT_TRUE(RunEvaluationTest("P >= 0.3 [count(area(clusters)) >= sqrt(0.9)]"));
}

TEST_F(SpatialEntitiesTraceTest, UnaryNumericMeasureTrunc) {
    EXPECT_TRUE(RunEvaluationTest("P >= 0.3 [count(area(clusters)) <= trunc(1.1)]"));
}
...
TEST_F(SpatialEntitiesTraceTest, UnaryNumericNumeric) {
    EXPECT_FALSE(RunEvaluationTest("P >= 0.3 [max([0, 11] count(area(clusters))) < 11]"));
}
...
TEST_F(SpatialEntitiesTraceTest, UnaryNumericSpatial) {
    EXPECT_TRUE(RunEvaluationTest("P >= 0.3 [F [0, 11] (max(floor(area(clusters))) = 27)]"));
}
...
TEST_F(SpatialEntitiesTraceTest, UnaryNumericTemporal) {
    EXPECT_TRUE(RunEvaluationTest("P >= 0.3 [count(area(clusters)) >= 0.9999]"));
}
...
TEST_F(SpatialEntitiesTraceTest, UnarySpatialConstraint) {
    EXPECT_FALSE(RunEvaluationTest("P <= 0.9 [count(area(filter(clusters, area <= 0.4))) = 1]"));
}
...
TEST_F(SpatialEntitiesTraceTest, UnaryStatisticalMeasureAvg) {
    EXPECT_TRUE(RunEvaluationTest("P >= 0.3 [avg(area(clusters)) < 1.00001]"));
}
...
TEST_F(SpatialEntitiesTraceTest, UnaryStatisticalMeasureHarmean) {
    EXPECT_FALSE(RunEvaluationTest("P >= 0.3 [harmean(area(clusters)) > 1.000001]"));
}

TEST_F(SpatialEntitiesTraceTest, UnaryStatisticalMeasureKurt) {
    EXPECT_FALSE(RunEvaluationTest("P >= 0.3 [kurt(area(clusters)) > 0]"));
}

TEST_F(SpatialEntitiesTraceTest, UnaryStatisticalMeasureMax) {
    EXPECT_FALSE(RunEvaluationTest("P >= 0.3 [max(area(clusters)) = 0]"));
}
...
TEST_F(SpatialEntitiesTraceTest, UnaryStatisticalMeasureProduct) {
    EXPECT_FALSE(RunEvaluationTest("P >= 0.3 [product(area(clusters)) < 1]"));
}

TEST_F(SpatialEntitiesTraceTest, UnaryStatisticalMeasureSkew) {
    EXPECT_TRUE(RunEvaluationTest("P >= 0.3 [skew(area(clusters)) = 0]"));
}

TEST_F(SpatialEntitiesTraceTest, UnaryStatisticalMeasureStdev) {
    EXPECT_FALSE(RunEvaluationTest("P >= 0.3 [stdev(area(clusters)) = 1]"));
}

TEST_F(SpatialEntitiesTraceTest, UnaryStatisticalMeasureSum) {
    EXPECT_FALSE(RunEvaluationTest("P >= 0.3 [sum(area(clusters)) = 0]"));
}
...
TEST_F(SpatialEntitiesTraceTest, UnaryStatisticalSpatial) {
    EXPECT_FALSE(RunEvaluationTest("P >= 0.3 [max([0, 5] count(area(clusters))) > 6]"));
}
...
TEST_F(SpatialEntitiesTraceTest, UntilLogicProperty) {
    EXPECT_FALSE(RunEvaluationTest("P >= 0.3 [(d(count(area(clusters))) >= 0) U [0, 3] {A} = 4]"));
}

TEST_F(SpatialEntitiesTraceTest, UntilLogicPropertyMultiple) {
    EXPECT_TRUE(RunEvaluationTest("P >= 0.3 [(d(count(area(clusters))) >= 0) U [0, 3] (count(area(clusters)) > 0) <=> (count(area(clusters)) = 3)]"));
}
...
TEST_F(SpatialEntitiesTraceTest, IncreasingUntilDecreasingValueNumericStateVariable2) {
    EXPECT_FALSE(RunEvaluationTest("P < 0.9 [(d({A}) > 0) U [0, 10] (d(count(area(clusters))) < 0)]"));
}
...
TEST_F(SpatialEntitiesTraceTest, IncreasingUntilDecreasingValueBinaryStatisticalNumeric) {
    EXPECT_FALSE(RunEvaluationTest("P < 0.9 [(d(covar(area(clusters), area(clusters))) >= 0) U [0, 10] (d(avg(area(filter(clusters, area > 5 V area < 10000)))) < 0)]"));
}
...
TEST_F(SpatialEntitiesTraceTest, TimeIntervalExceedsTraceEndTime) {
    EXPECT_FALSE(RunEvaluationTest("P < 0.9 [G [0, 1000] (count(area(clusters)) > 10)]"));
}

TEST_F(SpatialEntitiesTraceTest, TimeIntervalExceedsTraceStartTime) {
    EXPECT_FALSE(RunEvaluationTest("P < 0.9 [G [5, 10] (count(area(clusters)) > 10)]"));
}
...
TEST_F(SpatialEntitiesTraceTest, ConstraintsCombinationUnary) {
    EXPECT_FALSE(RunEvaluationTest("P < 0.9 [G [0, 5] (count(area(filter(clusters, area > 5))) > 10)]"));
}

TEST_F(SpatialEntitiesTraceTest, ConstraintsCombinationBinary) {
    EXPECT_FALSE(RunEvaluationTest("P < 0.9 [G [0, 5] (count(area(filter(clusters, area > 5 ^ area > 1000))) > 10)]"));
}

TEST_F(SpatialEntitiesTraceTest, ConstraintsCombinationNary) {
    EXPECT_FALSE(RunEvaluationTest("P < 0.9 [G [0, 5] (count(area(filter(clusters, (area > 5) ^ ((area > 1000) V (area > 100 V area < 210))))) > 10)]"));
}
