...
const std::string ModelCheckingOutputWriter::MSG_INTRO_NAME                         = "Mudi 0.6.122 (Multidimensional model checker)";
...
const std::string ModelCheckingOutputWriter::MSG_INIT_LOGIC_PROPERTIES_PATH = "Path to the logic properties input file:      ";
const std::string ModelCheckingOutputWriter::MSG_INIT_TRACES_FOLDER_PATH    = "Path to spatial-temporal traces input folder: ";
