...
\item 
static void \hyperlink{classmultiscale_1_1analysis_1_1DBSCAN_a52f0eb2d04029c75a3c48a37efdac26b}{run} (const vector$<$ shared\-\_\-ptr$<$ \hyperlink{classmultiscale_1_1analysis_1_1DataPoint}{Data\-Point} $>$$>$ \&data\-Points, vector$<$ int $>$ \&cluster\-Indexes, int \&nr\-Of\-Clusters, double \hyperlink{classmultiscale_1_1analysis_1_1DBSCAN_ac19e3e98b0db882c5676088a34197ec7}{eps}, int \hyperlink{classmultiscale_1_1analysis_1_1DBSCAN_a285a04240518d17e99565d78e9b78ff0}{min\-Points})
...
\begin{DoxyCompactItemize}
\item 
static void \hyperlink{classmultiscale_1_1analysis_1_1DBSCAN_aceb5dd9fe24a24cbf09ddc9082dc1f82}{run\-Algorithm} (const vector$<$ shared\-\_\-ptr$<$ \hyperlink{classmultiscale_1_1analysis_1_1DataPoint}{Data\-Point} $>$$>$ \&data\-Points, vector$<$ int $>$ \&cluster\-Indexes, int \&nr\-Of\-Clusters)
...
static void \hyperlink{classmultiscale_1_1analysis_1_1DBSCAN_a4770eddfc02c41deb114e5d42affd93a}{construct\-Distance\-Matrix} (const vector$<$ shared\-\_\-ptr$<$ \hyperlink{classmultiscale_1_1analysis_1_1DataPoint}{Data\-Point} $>$$>$ \&data\-Points)
\begin{DoxyCompactList}\small\item\em Construct the distance matrix between any two data points. \end{DoxyCompactList}\item 
static bool \hyperlink{classmultiscale_1_1analysis_1_1DBSCAN_a400c4e9fb1d9e9bafa970b33912a5ce1}{expand\-Core\-Cluster} (vector$<$ int $>$ \&cluster\-Indexes, int core\-Data\-Point\-Index, int cluster\-Id)
\begin{DoxyCompactList}\small\item\em Expand the cluster around the given core data point. \end{DoxyCompactList}\item 
static void \hyperlink{classmultiscale_1_1analysis_1_1DBSCAN_a6ead683810b4f04a48cd0a4d0f5f7a6b}{add\-Unclassified\-Nodes\-To\-Seeds\-List} (const vector$<$ int $>$ \&neighbours, const vector$<$ int $>$ \&cluster\-Indexes, vector$<$ int $>$ \&seeds)
\begin{DoxyCompactList}\small\item\em Add all unclassified neighbour nodes to the seeds list. \end{DoxyCompactList}\item 
static void \hyperlink{classmultiscale_1_1analysis_1_1DBSCAN_a5b0d19aab403005cac7fbe0851f5a969}{label\-Unclassified\-And\-Noise\-As\-Border} (const vector$<$ int $>$ \&neighbours, vector$<$ int $>$ \&cluster\-Indexes)
...
static vector$<$ int $>$ \hyperlink{classmultiscale_1_1analysis_1_1DBSCAN_a2524149cf55398e2038aaa389b56bfec}{retrieve\-Neighbours} (int data\-Point\-Index)
...
static void \hyperlink{classmultiscale_1_1analysis_1_1DBSCAN_a1c55a2e893f28de4a68129407c55d5f3}{assign\-Border\-Nodes\-To\-Clusters} (vector$<$ int $>$ \&cluster\-Indexes)
...
static int \hyperlink{classmultiscale_1_1analysis_1_1DBSCAN_a7a1c95e78edf9e804a7809648e130bda}{find\-Closest\-Core\-Data\-Point} (const vector$<$ int $>$ \&neighbours, int border\-Data\-Point\-Index, const vector$<$ int $>$ \&cluster\-Indexes)
...
static void \hyperlink{classmultiscale_1_1analysis_1_1DBSCAN_af50079a4d370fb35b13b0a1557a454f0}{allocate\-Distance\-Matrix} ()
\begin{DoxyCompactList}\small\item\em Allocate the distance matrix. \end{DoxyCompactList}\end{DoxyCompactItemize}
\subsection*{Static Private Attributes}
\begin{DoxyCompactItemize}
\item 
static double \hyperlink{classmultiscale_1_1analysis_1_1DBSCAN_ac19e3e98b0db882c5676088a34197ec7}{eps} = 0
\item 
static unsigned int \hyperlink{classmultiscale_1_1analysis_1_1DBSCAN_a285a04240518d17e99565d78e9b78ff0}{min\-Points} = 0
\item 
static unsigned int \hyperlink{classmultiscale_1_1analysis_1_1DBSCAN_aa0cb098abae4aa07e8488a5d2a72a4f4}{nr\-Of\-Data\-Points} = 0
\item 
static vector$<$ vector$<$ double $>$ $>$ \hyperlink{classmultiscale_1_1analysis_1_1DBSCAN_aa54a9933d643b06a6a2624d6f76b700f}{distance\-Matrix}
...
)\hspace{0.3cm}{\ttfamily [static]}, {\ttfamily [private]}}}\label{classmultiscale_1_1analysis_1_1DBSCAN_a6ead683810b4f04a48cd0a4d0f5f7a6b}
...
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [static]}, {\ttfamily [private]}}}\label{classmultiscale_1_1analysis_1_1DBSCAN_af50079a4d370fb35b13b0a1557a454f0}
...
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [static]}, {\ttfamily [private]}}}\label{classmultiscale_1_1analysis_1_1DBSCAN_a1c55a2e893f28de4a68129407c55d5f3}
...
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [static]}, {\ttfamily [private]}}}\label{classmultiscale_1_1analysis_1_1DBSCAN_a4770eddfc02c41deb114e5d42affd93a}
...
\item[{int}]{cluster\-Id}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [static]}, {\ttfamily [private]}}}\label{classmultiscale_1_1analysis_1_1DBSCAN_a400c4e9fb1d9e9bafa970b33912a5ce1}
...
\item[{const vector$<$ int $>$ \&}]{cluster\-Indexes}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [static]}, {\ttfamily [private]}}}\label{classmultiscale_1_1analysis_1_1DBSCAN_a7a1c95e78edf9e804a7809648e130bda}
...
\item[{vector$<$ int $>$ \&}]{cluster\-Indexes}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [static]}, {\ttfamily [private]}}}\label{classmultiscale_1_1analysis_1_1DBSCAN_a5b0d19aab403005cac7fbe0851f5a969}
...
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [static]}, {\ttfamily [private]}}}\label{classmultiscale_1_1analysis_1_1DBSCAN_a2524149cf55398e2038aaa389b56bfec}
...
\item[{int}]{min\-Points}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [static]}}}\label{classmultiscale_1_1analysis_1_1DBSCAN_a52f0eb2d04029c75a3c48a37efdac26b}
...
\item[{int \&}]{nr\-Of\-Clusters}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [static]}, {\ttfamily [private]}}}\label{classmultiscale_1_1analysis_1_1DBSCAN_aceb5dd9fe24a24cbf09ddc9082dc1f82}
...
\hypertarget{classmultiscale_1_1analysis_1_1DBSCAN_aa54a9933d643b06a6a2624d6f76b700f}{\index{multiscale\-::analysis\-::\-D\-B\-S\-C\-A\-N@{multiscale\-::analysis\-::\-D\-B\-S\-C\-A\-N}!distance\-Matrix@{distance\-Matrix}}
\index{distance\-Matrix@{distance\-Matrix}!multiscale::analysis::DBSCAN@{multiscale\-::analysis\-::\-D\-B\-S\-C\-A\-N}}
\subsubsection[{distance\-Matrix}]{\setlength{\rightskip}{0pt plus 5cm}vector$<$ vector$<$ double $>$ $>$ D\-B\-S\-C\-A\-N\-::distance\-Matrix\hspace{0.3cm}{\ttfamily [static]}, {\ttfamily [private]}}}\label{classmultiscale_1_1analysis_1_1DBSCAN_aa54a9933d643b06a6a2624d6f76b700f}
The matrix containing the distances between any two data points 

Definition at line 31 of file D\-B\-S\-C\-A\-N.\-hpp.



Referenced by allocate\-Distance\-Matrix(), construct\-Distance\-Matrix(), find\-Closest\-Core\-Data\-Point(), and retrieve\-Neighbours().

\hypertarget{classmultiscale_1_1analysis_1_1DBSCAN_ac19e3e98b0db882c5676088a34197ec7}{\index{multiscale\-::analysis\-::\-D\-B\-S\-C\-A\-N@{multiscale\-::analysis\-::\-D\-B\-S\-C\-A\-N}!eps@{eps}}
\index{eps@{eps}!multiscale::analysis::DBSCAN@{multiscale\-::analysis\-::\-D\-B\-S\-C\-A\-N}}
\subsubsection[{eps}]{\setlength{\rightskip}{0pt plus 5cm}double D\-B\-S\-C\-A\-N\-::eps = 0\hspace{0.3cm}{\ttfamily [static]}, {\ttfamily [private]}}}\label{classmultiscale_1_1analysis_1_1DBSCAN_ac19e3e98b0db882c5676088a34197ec7}
\begin{DoxyVerb}                              DBSCAN algorithm parameter for specifying the maximum radius
\end{DoxyVerb}
 of the neighbourhood 

Definition at line 24 of file D\-B\-S\-C\-A\-N.\-hpp.



Referenced by retrieve\-Neighbours(), and run().

\hypertarget{classmultiscale_1_1analysis_1_1DBSCAN_a285a04240518d17e99565d78e9b78ff0}{\index{multiscale\-::analysis\-::\-D\-B\-S\-C\-A\-N@{multiscale\-::analysis\-::\-D\-B\-S\-C\-A\-N}!min\-Points@{min\-Points}}
\index{min\-Points@{min\-Points}!multiscale::analysis::DBSCAN@{multiscale\-::analysis\-::\-D\-B\-S\-C\-A\-N}}
\subsubsection[{min\-Points}]{\setlength{\rightskip}{0pt plus 5cm}unsigned int D\-B\-S\-C\-A\-N\-::min\-Points = 0\hspace{0.3cm}{\ttfamily [static]}, {\ttfamily [private]}}}\label{classmultiscale_1_1analysis_1_1DBSCAN_a285a04240518d17e99565d78e9b78ff0}
...
\hypertarget{classmultiscale_1_1analysis_1_1DBSCAN_aa0cb098abae4aa07e8488a5d2a72a4f4}{\index{multiscale\-::analysis\-::\-D\-B\-S\-C\-A\-N@{multiscale\-::analysis\-::\-D\-B\-S\-C\-A\-N}!nr\-Of\-Data\-Points@{nr\-Of\-Data\-Points}}
\index{nr\-Of\-Data\-Points@{nr\-Of\-Data\-Points}!multiscale::analysis::DBSCAN@{multiscale\-::analysis\-::\-D\-B\-S\-C\-A\-N}}
\subsubsection[{nr\-Of\-Data\-Points}]{\setlength{\rightskip}{0pt plus 5cm}unsigned int D\-B\-S\-C\-A\-N\-::nr\-Of\-Data\-Points = 0\hspace{0.3cm}{\ttfamily [static]}, {\ttfamily [private]}}}\label{classmultiscale_1_1analysis_1_1DBSCAN_aa0cb098abae4aa07e8488a5d2a72a4f4}
Number of data points in the data set 

Definition at line 29 of file D\-B\-S\-C\-A\-N.\-hpp.
...
\item 
include/multiscale/analysis/spatial/\hyperlink{DBSCAN_8hpp}{D\-B\-S\-C\-A\-N.\-hpp}\item 
src/multiscale/analysis/spatial/\hyperlink{DBSCAN_8cpp}{D\-B\-S\-C\-A\-N.\-cpp}\end{DoxyCompactItemize}
