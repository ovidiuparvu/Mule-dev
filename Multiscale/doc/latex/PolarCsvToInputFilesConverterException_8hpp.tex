...
\begin{center}
\leavevmode
\includegraphics[width=222pt]{PolarCsvToInputFilesConverterException_8hpp__incl}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=228pt]{PolarCsvToInputFilesConverterException_8hpp__dep__incl}
\end{center}
\end{figure}
\subsection*{Classes}
