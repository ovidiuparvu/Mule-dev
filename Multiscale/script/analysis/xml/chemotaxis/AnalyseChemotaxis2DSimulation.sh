...
####################################################################################
# 
# Generate images for simulation file
#
####################################################################################
...
bin/RectangularMapEntityCsvToInputFiles --input-file "${OUT_INPUT_FOLDER}/${INPUT_BASENAME}" --nr-entities ${nrOfCells} --max-pileup ${maxPileup} --height ${simulationGridHeight} --width ${simulationGridWidth} --output-file "${OUT_INPUT_FOLDER}/${INPUT_BASENAME}";
