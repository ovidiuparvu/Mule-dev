...
void ClusterDetector::createTrackbars() {
    ...
    createTrackbar(TRACKBAR_EPS, WIN_OUTPUT_IMAGE, &minPoints, MIN_POINTS_MAX, nullptr, nullptr);
    createTrackbar(TRACKBAR_MINPOINTS, WIN_OUTPUT_IMAGE, &eps, EPS_MAX, nullptr, nullptr);
}
