...
string StringManipulator::replace(string& initialString, string replaceWhat, string replaceWith) {
...
vector<string> StringManipulator::split(string initialString, string delimiter) {
