...
#include "multiscale/verification/spatial-temporal/parsing/BinaryStatisticalMeasureGrammarDefinition.hpp"
...
template class BinaryStatisticalMeasureGrammar<iteratorType>;
