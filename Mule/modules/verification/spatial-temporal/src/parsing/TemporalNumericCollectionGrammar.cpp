...
#include "multiscale/verification/spatial-temporal/parsing/TemporalNumericCollectionGrammarDefinition.hpp"
...
template class TemporalNumericCollectionGrammar<iteratorType>;
